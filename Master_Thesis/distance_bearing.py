...
@author: Sia Stroemsnes and Marie Staveland
...
def bearing(lon1,lat1,lon2,lat2,base=1):
    ...
    compass_bearing = base*(round((initial_bearing + 360) % 360/base))
...
def sog(lon1,lat1,lon2,lat2,time1,time2):
    distance=euclidean(lon1,lat1,lon2,lat2)
    time=(time1-time2)/np.timedelta64(1,"h")
